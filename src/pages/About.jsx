  ...
  return (
    <div className="min-h-screen flex flex-col bg-cover bg-center" style={{ backgroundImage: 'url(/img/seg1.JPG)' }}>
      <div className=" text-white mt-10 ml-10" style={containerStyle}>
        ...
        <p className="mb-4 text-black bg-white rounded-lg font-thin text-2xl hover:bg-lime-500 w-fit hover:text-white transition-all duration-300">
      ...
      <div className="ml-11 mt-7">
        <h className=" text-5xl font-thin bg-white text-black "> What We Do ?</h>
        <h1 className="text-4xl font-thin  bg-white text-black w-fit">We Are Your Personal Digital</h1>
        <h3 className="text-3xl font-bold  bg-white text-black w-fit">Service From Start to End!</h3>
      </div>
    </div>
  );
}
